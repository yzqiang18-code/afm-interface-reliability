...
precision, and Brier score. Candidate selection is evaluated once per system.
All confidence intervals comparing selectors use paired bootstrap resampling of
complete systems. Oracle best-of-20 uses native DockQ retrospectively and is
reported only as a sampling ceiling.
...
three data figures using only committed public inputs.
